...
export async function POST(req: Request) {
    try {
        ...
        const { pageId, postId, replyText, replyText2, replyText3, privateMessage, includeName, keywords, activeDays } = await req.json();
        ...
        const newRule = await prisma.autoReplyRule.create({
            data: {
                ...
                postId,
                replyText,
                replyText2: replyText2 || null,
                replyText3: replyText3 || null,
