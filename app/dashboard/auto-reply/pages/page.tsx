        ...
        <div className="max-w-4xl mx-auto space-y-6" dir={locale === 'ar' ? 'rtl' : 'ltr'}>
            <header className="mb-8 flex flex-col md:flex-row md:items-start justify-between gap-4">
                ...
                <button
                    ...
                    className="px-6 py-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-medium rounded-xl shadow-sm transition-all active:scale-95 flex items-center justify-center gap-2 mt-4 md:mt-0"
                >
                    {locale === 'ar' ? "الرجوع للوحة التحكم" : "Back to Dashboard"}
                </button>
            </header>
