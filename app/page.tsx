      ...
      <nav className="fixed top-0 w-full z-50 bg-[#0B0E14]/85 backdrop-blur-md border-b border-white/5 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8 bg-[#151921]/50 px-6 py-2 rounded-full border border-white/5">
            ...
            <div className="flex items-center gap-4">
              {session ? (
                ...
                <>
                  <Link href="/studio" className="px-4 py-2 text-sm font-semibold text-slate-300 hover:text-white transition-colors">CMS Login</Link>
                  <Link href="/login" className="px-5 py-2.5 bg-[#1877F2] hover:bg-blue-600 text-white text-sm font-semibold rounded-lg shadow-lg shadow-[#1877F2]/25 transition-all active:scale-95 border border-[#1877F2]/50 inline-block text-center">Register</Link>
                </>
              )}
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8 max-w-xl">
                ...
                <div className="pt-8 flex items-center gap-4 text-sm text-slate-500">
                  ...
                  <p>Trusted by marketers worldwide</p>
                </div>
              </div>
              ...
              <div className="relative group hidden lg:block">
                ...
                <div className="relative bg-[#151921] rounded-2xl border border-[#2A303C] shadow-2xl overflow-hidden ring-1 ring-white/5 pb-0">
                  <div className="absolute top-0 left-0 right-0 h-10 bg-[#1A1F29] border-b border-[#2A303C] flex items-center px-4 gap-2">
        ...
        <section id="features" className="py-24 relative">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Why Choose {settings?.siteName || 'Meta Manager'}</h2>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="group p-8 rounded-2xl bg-[#151921] border border-[#2A303C] hover:shadow-[0_0_0_1px_rgba(24,119,242,0.3),_0_20px_40px_-10px_rgba(0,0,0,0.5)] transition-all duration-300">
                ...
                <h3 className="text-xl font-bold mb-3 text-white group-hover:text-[#1877F2] transition-colors">Centralized Management</h3>
                <p className="text-slate-400 leading-relaxed text-sm">Control all Meta ad accounts from one intuitive dashboard. Eliminate account switching and fragmentation with a unified view.</p>
              </div>
              ...
              <div className="group p-8 rounded-2xl bg-[#151921] border border-[#2A303C] hover:shadow-[0_0_0_1px_rgba(24,119,242,0.3),_0_20px_40px_-10px_rgba(0,0,0,0.5)] transition-all duration-300">
                ...
                <h3 className="text-xl font-bold mb-3 text-white group-hover:text-[#1877F2] transition-colors">Unified Billing</h3>
                <p className="text-slate-400 leading-relaxed text-sm">Streamlined payments and consolidated invoicing for all your linked accounts. No more payment headaches across multiple profiles.</p>
              </div>
              ...
              <div className="group p-8 rounded-2xl bg-[#151921] border border-[#2A303C] hover:shadow-[0_0_0_1px_rgba(24,119,242,0.3),_0_20px_40px_-10px_rgba(0,0,0,0.5)] transition-all duration-300">
                ...
                <h3 className="text-xl font-bold mb-3 text-white group-hover:text-[#1877F2] transition-colors">AI Automation</h3>
                <p className="text-slate-400 leading-relaxed text-sm">Leverage AI for optimized audience targeting and performance. Automate the mundane and focus on high-impact creative strategies.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4">
          <div className="max-w-5xl mx-auto rounded-3xl bg-gradient-to-br from-[#1877F2] to-blue-700 px-8 py-16 text-center text-white shadow-2xl shadow-[#1877F2]/10 relative overflow-hidden border border-white/10">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl md:text-5xl font-extrabold mb-6 text-white tracking-tight">Ready to scale your business?</h2>
              <p className="text-blue-100 text-lg mb-10 max-w-2xl mx-auto font-light">Join 10,000+ marketers who trust our platform to manage their Meta advertising ecosystem.</p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="#features" className="bg-blue-800/50 text-white border border-white/20 px-8 py-3.5 rounded-xl font-bold hover:bg-blue-800 transition-colors flex items-center justify-center">Learn More</Link>
              </div>
            </div>
          </div>
        </section>
