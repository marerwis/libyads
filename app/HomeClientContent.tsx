                ...
                <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-[radial-gradient(circle_at_50%_0%,rgba(24,119,242,0.08)_0%,transparent_60%)]">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex flex-col items-center text-center max-w-4xl mx-auto space-y-10">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#151921] border border-[#2A303C] text-[#1877F2] text-xs font-bold tracking-wider shadow-sm">
                            ...
                            <div className="flex flex-wrap justify-center gap-4 pt-6">
                                <Link href="#features" className="px-10 py-4 bg-[#151921] border border-[#2A303C] text-slate-200 font-semibold rounded-xl hover:bg-white/5 transition-all active:scale-95 flex items-center justify-center">
                                    {t("learnMore")}
                                </Link>
                                <Link href={session ? "/dashboard" : "/login"} className="px-10 py-4 bg-[#1877F2] hover:bg-blue-600 text-white font-bold rounded-xl shadow-xl shadow-[#1877F2]/20 transition-all active:scale-95 flex items-center gap-2 border border-white/10">
                                    {t("openDashboard")}
                                </Link>
                            </div>

                            <div className="pt-10 flex items-center justify-center gap-4 text-sm text-slate-500">
                                <p>{t("trustedBy")}</p>
