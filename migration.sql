...
CREATE TABLE "MetaSetting" (
    ...
    CONSTRAINT "MetaSetting_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "MetaSetting_userId_key" ON "MetaSetting"("userId");
...
-- AddForeignKey
ALTER TABLE "MetaSetting" ADD CONSTRAINT "MetaSetting_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
